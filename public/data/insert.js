...
for(var i = 0; i < new_list.length; i++) {
	db.news.insert({id:new_list[i].id, title:new_list[i].title, author:new_list[i].author, abstract:new_list[i].abstract, like:new_list[i].like, dislike: new_list[i].dislike, time:new_list[i].time, img:new_list[i].img, content:new_list[i].content});
}
